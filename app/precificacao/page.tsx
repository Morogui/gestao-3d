                                                                                      ...
                                                                                      ? [
                                                                                                            ...
                                                                                                            c(
                                                                                                                                    "th",
                                                                                                                {
                                                                                                                                          ...
                                                                                                                                          title: "Considera o custo de Ads (Mercado Ads) no cálculo da margem deste produto",
                                                                                                                    },
                                                                                                                                    "Ads ML"
                                                                                                                                    ),
                                                                                                            c(
                                                                                                                                    "th",
                                                                                                                {
                                                                                                                                          key: "th-afiliado-ml",
                                                                                                                                          className: "px-3 py-3 text-center",
                                                                                                                                          title: "Considera comissão de Parceiros/afiliados no cálculo da margem deste produto",
                                                                                                                    },
                                                                                                                                    "Afiliado ML"
                                                                                                                                    ),
                                                                                                            c(
                                                                                      ...
                                                                                      ? [
                                                                                                            ...
                                                                                                            c(
                                                                                                                                    "th",
                                                                                                                {
                                                                                                                                          key: "th-ads-shopee",
                                        className: "px-3 py-3 text-center",
                                                                                                                                          title: "Considera o custo de Ads (Shopee Ads) no cálculo da margem deste produto",
                                                                                                                    },
                                                                                                                                    "Ads Shopee"
                                                                                                                                    ),
                                                                                                            c(
                                                                                                                                    "th",
                                                                                                                {
                                                                                                                                          ...
                                                                                                                                          className: "px-3 py-3 text-center",
                                                                                                                                          title: "Considera comissão de afiliados no cálculo da margem deste produto",
                                                                                                                    },
                                                                                                                                    "Afiliado Shopee"
                                                                                                                                    ),
                                                                                                            c(
...
function toggleAdsML(checked: boolean) {
    ...
    function toggleAfiliadoML(checked: boolean) {
          onChangeLocal(
                  checked ? { usaAfiliadoML: true, usaAdsML: false } : { usaAfiliadoML: false }
                  );
          setTimeout(onSalvar, 0);
    }
    function toggleAdsShopee(checked: boolean) {
          onChangeLocal(
                  checked ? { usaAdsShopee: true, usaAfiliadoShopee: false } : { usaAdsShopee: false }
                  );
          setTimeout(onSalvar, 0);
    }
    function toggleAfiliadoShopee(checked: boolean) {
          onChangeLocal(
                  checked ? { usaAfiliadoShopee: true, usaAdsShopee: false } : { usaAfiliadoShopee: false }
                  );
          setTimeout(onSalvar, 0);
    }
            ...
            : "—"
              ...
              ...(mostrarShopee
                          ? [
                                        ...
                                        c(
                                                        "td",
                                            { key: "td-afiliado-shopee", className: "px-3 py-2 text-center" },
                                                        c("input", {
                                                                          type: "checkbox",
