              ...
              { className: "rounded-lg border border-gray-200 bg-white p-5" },
                    ...
                    c(
                        ...
                        { className: "mb-4 rounded-md bg-blue-50 p-3 text-xs text-blue-900" },
                                "Comissão ML (11,5% Clássico), tarifa por peso do ML e comissão + tarifa fixa da Shopee já vêm calibradas com dados reais verificados em 19/08/2026 — não precisam de ajuste manual. Imposto, ADS, afiliado Shopee e embalagem são estimativas editáveis (imposto e embalagem ainda precisam de confirmação). Reembolso e custo do Flex ML: você confirmou que o ML reembolsa parte do custo mas ainda há um custo real que você paga — os valores abaixo ficam em R$0 até você levantar os números exatos."
                              ),
                    c(
                                "div",
                        { className: "grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-8" },
                                c(NumberField, {
                                              label: "Imposto (%)",
