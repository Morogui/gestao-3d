            ...
            expandido
              ? c(
                    ...
                    { className: "bg-gray-50" },
                              c(
                                                "td",
                                    { colSpan: 11, className: "px-3 py-3" },
                                                c(
                                                                    "div",
                                                      {
                                                                            className:
                                                                                                    "mb-3 flex flex-wrap items-end gap-4 rounded-md border border-gray-200 bg-white p-3",
                                                      },
                                                                    c(
                                                                                          "label",
                                                                          { className: "block" },
                                                                                          ...
                                                                                          c("input", {
                                                                                                                  ...
                                                                                                                  onChange: (e: React.ChangeEvent<HTMLInputElement>) =>
                                                                                                                                            onChangeLocal({
                                                                                                                                                                        embalagemCusto: parseFloat(e.target.value) || 0,
                                                                                                                                                  }),
                                                                                                                  onBlur: onSalvar,
                                                                                                                  className:
                                                                                                                                            "w-24 rounded border border-gray-200 px-2 py-1 text-right text-sm",
                                                                                                ...
                                                                                                { className: "mb-1 block text-xs font-medium text-gray-600" },
                                                                                                                  ...
                                                                                                                  c(
                                                                                                                        ...
                                                                                                                        { className: "ml-1 text-[10px] font-normal text-gray-400" },
                                                                                                                                            "pré-preenchida com a margem real do preço atual — pode mudar pra simular"
                                                                                                                                          )
                                                                                                                ),
                                                                                          c("input", {
                                                                                                                  type: "number",
