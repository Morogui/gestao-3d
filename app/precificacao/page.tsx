...
className: "px-3 py-3 text-right",
title:
"Custo do conjunto vendido (kit 1/2/3, corpo+gancho etc). Por padrão vem da placa (1 peça); edite quando o SKU real for um conjunto de peças.",
},
"Custo produção"
),
c(
...
`peça: ${formatBRL(produto.custoProducaoCalculado)}`
)
: null
),
c(
