      ...
      c(
        ...
        c(
          ...
          c(
            ...
            salvandoConfig ? "Salvando..." : "Salvar configuraÃ§Ã£o"
          )
        )
      ),
      c(
        ...
        "ComissÃ£o ML (11,5% ClÃ¡ssico), tarifa por peso do ML e comissÃ£o + tarifa fixa da Shopee jÃ¡ vÃªm calibradas com dados reais verificados em 19/08/2026 â nÃ£o precisam de ajuste manual. Embalagem agora Ã© configurada por produto, direto na tabela abaixo. Margem ML/Shopee mostra a margem real, calculada a partir do preÃ§o de venda que vocÃª preencher em cada produto. Imposto, ADS e afiliado Shopee continuam editÃ¡veis aqui e ainda precisam de confirmaÃ§Ã£o. Custo do Flex ML: vocÃª confirmou que o ML reembolsa parte do custo mas ainda hÃ¡ um custo real que vocÃª paga â o valor abaixo fica em R$0 atÃ© vocÃª levantar o nÃºmero exato."
      ),
      c(
        "div",
                ...
                c(
                  ...
                  c(
                    "th",
                    {
                      className: "px-3 py-3 text-right",
                      title:
                        "Custo do conjunto vendido (kit 1/2/3, corpo+gancho etc). Por padrÃ£o vem da placa (1 peÃ§a); edite quando o SKU real for um conjunto de peÃ§as.",
                    },
                    "Custo produÃ§Ã£o"
                  ),
                  c(
      ...
      c(
        ...
        produto.custoProducao !== produto.custoProducaoCalculado
          ? c(
              ...
              `peÃ§a: ${formatBRL(produto.custoProducaoCalculado)}`
            )
          : null
      ),
      c(
      ...
      ...(mostrarML
        ? [
            ...
            c(
              ...
              produto.resultadoML ? formatBRL(produto.resultadoML.lucro) : "â"
            ),
            c(
              "td",
              {
      ...
      ...(mostrarShopee
        ? [
            ...
            c(
              ...
              produto.resultadoShopee ? formatBRL(produto.resultadoShopee.lucro) : "â"
            ),
            c(
              "td",
              {
...
function DetalhePlataforma({
  ...
  if (!resultado) {
    return c(
      ...
      c("div", { className: "text-xs text-gray-400" }, "Defina um preÃ§o de venda para ver o detalhamento.")
    );
  }
  const linhas: [string, number][] = [
    ["PreÃ§o de venda", resultado.preco],
    ["ComissÃ£o", -resultado.comissao],
  ...
  linhas.push(["Custo de produÃ§Ã£o", -resultado.custoProducao]);
  return c(
    "div",
    { className: "rounded-md border border-gray-200 bg-white p-3" },
