    ...
    <div className="min-h-screen bg-[#0a0a0d] px-4 py-6 sm:px-8">
      ...
      <section className="relative mb-6 overflow-hidden rounded-2xl bg-gradient-to-r from-amber-600 via-amber-500 to-orange-500 px-6 py-10 text-center sm:px-10">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute left-0 right-[54%] inset-y-0 flex items-end justify-between px-3">
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "40%", transformOrigin: "bottom", animation: "ctaBarPulse 2.2s ease-in-out infinite" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "70%", transformOrigin: "bottom", animation: "ctaBarPulse 2.6s ease-in-out infinite", animationDelay: "0.3s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "55%", transformOrigin: "bottom", animation: "ctaBarPulse 2.4s ease-in-out infinite", animationDelay: "0.6s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "85%", transformOrigin: "bottom", animation: "ctaBarPulse 2.8s ease-in-out infinite", animationDelay: "0.15s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "65%", transformOrigin: "bottom", animation: "ctaBarPulse 2.3s ease-in-out infinite", animationDelay: "0.45s" }} />
          </div>
          <div className="absolute right-0 left-[54%] inset-y-0 flex items-end justify-between px-3">
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "60%", transformOrigin: "bottom", animation: "ctaBarPulse 2.5s ease-in-out infinite", animationDelay: "0.2s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "35%", transformOrigin: "bottom", animation: "ctaBarPulse 2.1s ease-in-out infinite", animationDelay: "0.5s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "80%", transformOrigin: "bottom", animation: "ctaBarPulse 2.7s ease-in-out infinite", animationDelay: "0.1s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "50%", transformOrigin: "bottom", animation: "ctaBarPulse 2.4s ease-in-out infinite", animationDelay: "0.7s" }} />
            <div className="w-2.5 rounded-t bg-white/25 sm:w-3.5" style={{ height: "90%", transformOrigin: "bottom", animation: "ctaBarPulse 2.9s ease-in-out infinite", animationDelay: "0.35s" }} />
          </div>
        </div>
        <div className="relative z-10">
