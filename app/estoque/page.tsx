...
export default function EstoquePage() {
  ...
  // verdade — pedido do Guilherme em 2026-08-11. Cada cor do pedido é
  // uma linha própria em compras_filamento (mesmo padrão de
...
// do Guilherme em 2026-08-11: "eu comprei filamento no dia 7, porem ele
// nao chegou, entao nao entrou em estoque, precisava conseguir lançar a
// compra e quando ele chegar eu conseguir lançar ele". Agrupa por
// pedidoId (as várias cores de um mesmo "Salvar pedido" ficam juntas
// numa linha só) e deixa confirmar a chegada — só nesse momento o peso
