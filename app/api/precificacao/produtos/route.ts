...
SELECT produto_id, peso_envio_kg, preco_venda_ml, preco_venda_shopee, enviado_por_flex_ml
  ...
  ? {
    ...
    const resultado = produtos.map((p) => {
      ...
      const enviadoPorFlexML = override?.enviado_por_flex_ml === true;
                                   ...
                                   const resultadoML =
                                     precoVendaML != null
      ? calcularML(precoVendaML, pesoEnvioKg, custo.custoUnitario, config, enviadoPorFlexML)
                                     : null;
...
export async function PUT(request: NextRequest) {
  ...
  const { produtoId, pesoEnvioKg, precoVendaML, precoVendaShopee, enviadoPorFlexML } = body as {
    produtoId: number;
...
await sql`
INSERT INTO precificacao_produtos (produto_id, peso_envio_kg, preco_venda_ml, preco_venda_shopee, enviado_por_flex_ml, atualizado_em)
VALUES (${produtoId}, ${pesoEnvioKg}, ${precoVendaML}, ${precoVendaShopee}, ${enviadoPorFlexML === true}, now())
