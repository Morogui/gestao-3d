                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                      custo_flex_ml = ${custoFlexML},
                                                                                                                                                                                                                                                                                                                                                                                                            atualizado_em = now()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      WHERE id = ${existing[0].id}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    RETURNING imposto_pct, ads_pct_ml, ads_pct_shopee, afiliado_pct_ml, afiliado_pct_shopee, embalagem_custo, margem_desejada_pct, reembolso_flex_ml, custo_flex_ml
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      `) as ConfigRow[];
        } else {
                      rows = (await sql`
                                    INSERT INTO precificacao_config (imposto_pct, ads_pct_ml, ads_pct_shopee, afiliado_pct_ml, afiliado_pct_shopee, embalagem_custo, margem_desejada_pct, reembolso_flex_ml, custo_flex_ml)
                                                      VALUES (${impostoPct}, ${adsPctML}, ${adsPctShopee}, ${afiliadoPctML}, ${afiliadoPctShopee}, ${embalagemCusto}, ${margemDesejadaPct}, ${reembolsoFlexML}, ${custoFlexML})
                                                                            RETURNING imposto_pct, ads_pct_ml, ads_pct_shopee, afiliado_pct_ml, afiliado_pct_shopee, embalagem_custo, margem_desejada_pct, reembolso_flex_ml, custo_flex_ml
                                                                                                      `) as ConfigRow[];
        }
        return NextResponse.json(toConfig(rows[0]));
