...
export function calcularML(
    ...
    // Mercado Envios Flex confirmado (8 pedidos reais + tela do vendedor)
  // com custo adicional real de R$0 -- nao entra na conta.
  const lucro =
        preco - comissao - taxaFixa - imposto - ads - embalagem - custoProducao;
